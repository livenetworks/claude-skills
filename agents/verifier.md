...
- `components/ln-{name}/README.md` — does it reflect new/changed attributes, events, API, and does its `## 🔧 Internals` section match the implementation?
- `docs-mcp/css/{name}.md` — does CSS doc reflect new mixins or tokens?
