---
name: ashlar-css
description: "Senior CSS/SCSS developer persona for token-driven design systems. Use this skill whenever writing SCSS styles, CSS architecture, form layouts, component styling, or any frontend styling task. Triggers on any mention of ashlar or ln-ashlar SCSS, CSS, mixins, tokens, design tokens, component styling, form grids, hover effects, or design systems. Also use when reviewing or refactoring SCSS, or when deciding between presentational classes vs mixin-based styling."
---
